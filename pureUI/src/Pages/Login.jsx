      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-[#111827]/60 backdrop-blur-xl p-6 rounded-2xl border border-gray-800 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full mt-2 bg-gradient-to-r from-[#00acee] to-[#0072ff] hover:brightness-110 text-white font-semibold py-2.5 rounded-lg shadow-[0_0_15px_rgba(0,172,238,0.2)] transition-all active:scale-[0.98] text-sm"
            >
              Sign In
            </button>
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-2 bg-[#1f2937] hover:bg-[#2d3748] text-white font-medium py-2 rounded-lg border border-gray-700 transition-all text-sm"
            >
